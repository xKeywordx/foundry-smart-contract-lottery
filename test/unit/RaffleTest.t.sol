...
contract RaffleTest is Test {
    ...
    uint256 public constant STRATING_USER_BALANCE = 10 ether;
    ...
    function setUp() external {
        ...
        vm.deal(PLAYER, STRATING_USER_BALANCE);
    }
        ...
        skipFork
    {
        ...
        for (
            ...
            hoax(player, STRATING_USER_BALANCE);
            raffle.enterRaffle{value: entranceFee}();
        }
        ...
        assert(
            raffle.getRecentWinner().balance ==
                STRATING_USER_BALANCE + prize - entranceFee
        );
    }
}
